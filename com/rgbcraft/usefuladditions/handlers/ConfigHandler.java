...
//		this.config.get("items", "FluidCounterSensorCard", 3004);
		...
		this.config.get("items", "OilCanister", 1133);
		this.config.get("items", "DieselCanister", 1134);
		this.config.get("items", "SaltWaterCanister", 1135);
		...
		this.config.get("items", "BasicProcessor", 1164);
		this.config.get("items", "AdvancedProcessor", 1165);
